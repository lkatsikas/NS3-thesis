...
using namespace ns3;
using namespace std;
NS_LOG_COMPONENT_DEFINE("V2vAffinityExample");
...
void printNumberofClusterMembers(NodeContainer ueNodes){
    ...
    for (uint32_t u = 0; u < ueNodes.GetN(); ++u) {
        ...
        Ptr<V2vAffinityAlgorithmClient> tmp = temp->GetObject<V2vAffinityAlgorithmClient>();
...
int main(int argc, char *argv[]) {
    ...
    NS_LOG_UNCOND("/----------------------------------------------------------------------------------------\\");
    NS_LOG_UNCOND(" - Affinity Propagation Algorithm for VANETs [Example] -> Cluster vehicles communication");
    NS_LOG_UNCOND("\\----------------------------------------------------------------------------------------/");
    /*----------------------------------------------------------------------*/
    ...
    for (uint32_t u = 0; u < ueNodes.GetN(); ++u) {
        ...
        V2vAffinityAlgorithmHelper ueClient("ns3::UdpSocketFactory", Address(InetSocketAddress(Ipv4Address::GetBroadcast(), controlPort)),
