...
V2vNovelAlgorithmHelper::V2vNovelAlgorithmHelper(std::string protocolLocal, Address addressLocal,
    std::string protocolListeningLocal, Address addressListeningLocal, Ptr<MobilityModel> mobilityModel)
{
  m_factory.SetTypeId ("ns3::V2vNovelAlgorithmClient");
...
void
V2vNovelAlgorithmHelper::SetAttribute (std::string name, const AttributeValue &value)
{
  m_factory.Set (name, value);
}

ApplicationContainer
V2vNovelAlgorithmHelper::Install (Ptr<Node> node) const
{
  return ApplicationContainer (InstallPriv (node));
}

ApplicationContainer
V2vNovelAlgorithmHelper::Install (std::string nodeName) const
{
...
ApplicationContainer
V2vNovelAlgorithmHelper::Install (NodeContainer c) const
{
...
Ptr<Application>
V2vNovelAlgorithmHelper::InstallPriv (Ptr<Node> node) const
{
  Ptr<Application> app = m_factory.Create<V2vNovelAlgorithmClient> ();
